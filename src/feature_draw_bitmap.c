...
#define NUMBER_OF_IMAGES 1
	const int IMAGE_RESOURCE_BLACK_IDS[10][4] = {
{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_0,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_0,RESOURCE_ID_IMAGE_NUM_BLACK_UP_0,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_0
},
{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_1,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_1,RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_1,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_1
},
	{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_2,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_2,RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_2,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_2
},
{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_3,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_3,RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_3,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_3
},
{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_4,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_4,RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_4,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_4
},
{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_5,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_5,RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_5,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_5
},
{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_6,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_6,RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_6,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_6
},
{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_7,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_7,RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_7,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_7
},
{
	RESOURCE_ID_IMAGE_NUM_BLACK_UP_8,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_8,RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_8,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_8
},
{
	RESOURCE_ID_IMAGE_NUM_BLACK_DOWN_6,RESOURCE_ID_IMAGE_NUM_BLACK_RIGHT_6,RESOURCE_ID_IMAGE_NUM_BLACK_UP_6,RESOURCE_ID_IMAGE_NUM_BLACK_LEFT_6
}
};
...
enum {
	...
	UIInterfaceOrientationLandscapeRight = 1,
...
//	};
	...
	GRect frame = (GRect) {
    .origin = { (islot_number % 2) * 72, (islot_number / 2) * 84 },
    .size = images[nslot_number]->bounds.size
  };
